...
int main3()
{
	...
	[[maybe_unused]]
	stdx::templates::permutated_tuple<stdx::templates::typetuple<short, int, long, long long>, stdx::templates::valuetuple<1, 3, 0, 2>> t4;

	[[maybe_unused]]
	stdx::templates::transformed_typetuple<pointer_type, stdx::templates::typetuple<int, char>> t5;
